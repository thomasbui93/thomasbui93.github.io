...
export const Career = () => {
  const careers = [{
    ...
    companyIcon: "https://media-exp1.licdn.com/dms/image/C4D0BAQGtnStjF-vq9w/company-logo_100_100/0/1591210050428?e=1626307200&v=beta&t=f9057vSnyo1VSTRs2yx4Hrk19rXehXxl3Om-C2227ek",
    start: "August 2019",
    end: "Present",
    skills: ["Java", "Node.js", "Ruby", "React", "MySQL", "Kafka", "Redis", "Kubernetes", "Spinnaker", "Docker"],
    details: [{
    ...
    companyIcon: "https://media-exp1.licdn.com/dms/image/C560BAQFF-1fwHIT9AQ/company-logo_100_100/0/1519897341882?e=1626307200&v=beta&t=8Z1JyUqJqV9KNWV4PJS8SXCn2-W5AxGhKeW9BMBjxfM",
    start: "March 2018",
    end: "July 2019",
    ...
    companyIcon: "https://media-exp1.licdn.com/dms/image/C560BAQEoQquyRBqxCg/company-logo_100_100/0/1519884471543?e=1626307200&v=beta&t=CETkg8X7b8Ah02EDz7YkTknNmbbcCIRD3aIYxiKZt-Y",
    start: "April 2016",
    end: "March 2018",
    ...
    <Col justifyContent="center">
      <div className={style.brief}>
        ...
        <Paragraph size="small">
          <SM tag="span"> I'm a polygot Software Engineer, who enjoys building applications.</SM>
        </Paragraph>
      </div>
    </Col>
    <Col justifyContent="center">
      {careers.map((career, index) => <CareerPiece key={index} {...career}/>)}
    </Col>    
  </div>
}
